...
static PyMethodDef mod_p4vy88n23vfk_p4vy88n23vfk_methods[] = {
    {
        "matrix_prod_py",
...
static PyModuleDef_Slot mod_p4vy88n23vfk_p4vy88n23vfk_slots[] = {
...
static struct PyModuleDef mod_p4vy88n23vfk_p4vy88n23vfk_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_p4vy88n23vfk_p4vy88n23vfk",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_p4vy88n23vfk_p4vy88n23vfk_methods,
    mod_p4vy88n23vfk_p4vy88n23vfk_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_p4vy88n23vfk_p4vy88n23vfk(void)
{
    import_array();
    return PyModuleDef_Init(&mod_p4vy88n23vfk_p4vy88n23vfk_module);
}
