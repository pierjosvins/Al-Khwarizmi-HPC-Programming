module bind_c_reduction_tab_y067bpi79bir_y067bpi79bir

  use reduction_tab_y067bpi79bir_y067bpi79bir, only: initialize_table
  use reduction_tab_y067bpi79bir_y067bpi79bir, only: threads_num
  use reduction_tab_y067bpi79bir_y067bpi79bir, only: reduction
...
end module bind_c_reduction_tab_y067bpi79bir_y067bpi79bir
