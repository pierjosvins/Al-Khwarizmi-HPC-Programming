module bind_c_reduction_tab_mxonmhb0ro3e_mxonmhb0ro3e

  use reduction_tab_mxonmhb0ro3e_mxonmhb0ro3e, only: initialize_table
  use reduction_tab_mxonmhb0ro3e_mxonmhb0ro3e, only: reduction
  use reduction_tab_mxonmhb0ro3e_mxonmhb0ro3e, only: threads_num
...
end module bind_c_reduction_tab_mxonmhb0ro3e_mxonmhb0ro3e
