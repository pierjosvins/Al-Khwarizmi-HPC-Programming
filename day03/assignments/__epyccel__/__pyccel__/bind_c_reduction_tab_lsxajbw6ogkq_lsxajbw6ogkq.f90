module bind_c_reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq

  use reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq, only: reduction_openmp
  use reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq, only: reduction
  use reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq, only: initialize_table
  use reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq, only: &
        initialize_table_openmp
  use reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq, only: threads_num
...
end module bind_c_reduction_tab_lsxajbw6ogkq_lsxajbw6ogkq
