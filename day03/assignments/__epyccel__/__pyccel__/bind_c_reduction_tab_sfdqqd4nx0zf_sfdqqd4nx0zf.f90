module bind_c_reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf

  use reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf, only: initialize_table
  use reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf, only: reduction_openmp
  use reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf, only: threads_num
  use reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf, only: &
        initialize_table_openmp
  use reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf, only: reduction
...
end module bind_c_reduction_tab_sfdqqd4nx0zf_sfdqqd4nx0zf
