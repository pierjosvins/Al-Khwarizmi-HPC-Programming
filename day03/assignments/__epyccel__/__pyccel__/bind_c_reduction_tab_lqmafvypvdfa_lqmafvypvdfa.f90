module bind_c_reduction_tab_lqmafvypvdfa_lqmafvypvdfa

  use reduction_tab_lqmafvypvdfa_lqmafvypvdfa, only: reduction
  use reduction_tab_lqmafvypvdfa_lqmafvypvdfa, only: threads_num
  use reduction_tab_lqmafvypvdfa_lqmafvypvdfa, only: initialize_table
...
end module bind_c_reduction_tab_lqmafvypvdfa_lqmafvypvdfa
