module bind_c_reduction_tab_x4pgt807tejc_x4pgt807tejc

  use reduction_tab_x4pgt807tejc_x4pgt807tejc, only: &
        initialize_table_openmp
  use reduction_tab_x4pgt807tejc_x4pgt807tejc, only: reduction_openmp
  use reduction_tab_x4pgt807tejc_x4pgt807tejc, only: initialize_table
  use reduction_tab_x4pgt807tejc_x4pgt807tejc, only: threads_num
  use reduction_tab_x4pgt807tejc_x4pgt807tejc, only: reduction
...
end module bind_c_reduction_tab_x4pgt807tejc_x4pgt807tejc
