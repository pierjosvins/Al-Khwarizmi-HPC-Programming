...
static PyMethodDef mod_q8if5ny5wdrr_q8if5ny5wdrr_methods[] = {
    {
...
static PyModuleDef_Slot mod_q8if5ny5wdrr_q8if5ny5wdrr_slots[] = {
...
static struct PyModuleDef mod_q8if5ny5wdrr_q8if5ny5wdrr_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_q8if5ny5wdrr_q8if5ny5wdrr",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_q8if5ny5wdrr_q8if5ny5wdrr_methods,
    mod_q8if5ny5wdrr_q8if5ny5wdrr_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_q8if5ny5wdrr_q8if5ny5wdrr(void)
{
    import_array();
    return PyModuleDef_Init(&mod_q8if5ny5wdrr_q8if5ny5wdrr_module);
}
