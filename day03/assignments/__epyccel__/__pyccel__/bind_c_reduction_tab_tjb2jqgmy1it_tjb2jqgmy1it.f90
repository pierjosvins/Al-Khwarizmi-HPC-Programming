module bind_c_reduction_tab_tjb2jqgmy1it_tjb2jqgmy1it

  use reduction_tab_tjb2jqgmy1it_tjb2jqgmy1it, only: initialize_table
  use reduction_tab_tjb2jqgmy1it_tjb2jqgmy1it, only: threads_num
  use reduction_tab_tjb2jqgmy1it_tjb2jqgmy1it, only: reduction
...
end module bind_c_reduction_tab_tjb2jqgmy1it_tjb2jqgmy1it
