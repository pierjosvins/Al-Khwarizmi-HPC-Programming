module bind_c_reduction_tab_qsavliffbwi3_qsavliffbwi3

  use reduction_tab_qsavliffbwi3_qsavliffbwi3, only: initialize_table
  use reduction_tab_qsavliffbwi3_qsavliffbwi3, only: reduction
  use reduction_tab_qsavliffbwi3_qsavliffbwi3, only: threads_num
...
end module bind_c_reduction_tab_qsavliffbwi3_qsavliffbwi3
