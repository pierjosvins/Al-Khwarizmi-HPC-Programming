module bind_c_reduction_tab_whp7kontuqnj_whp7kontuqnj

  use reduction_tab_whp7kontuqnj_whp7kontuqnj, only: initialize_table
  use reduction_tab_whp7kontuqnj_whp7kontuqnj, only: reduction
  use reduction_tab_whp7kontuqnj_whp7kontuqnj, only: threads_num
...
end module bind_c_reduction_tab_whp7kontuqnj_whp7kontuqnj
