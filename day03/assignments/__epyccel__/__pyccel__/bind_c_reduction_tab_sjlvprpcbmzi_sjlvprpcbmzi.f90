module bind_c_reduction_tab_sjlvprpcbmzi_sjlvprpcbmzi

  use reduction_tab_sjlvprpcbmzi_sjlvprpcbmzi, only: threads_num
  use reduction_tab_sjlvprpcbmzi_sjlvprpcbmzi, only: initialize_table
  use reduction_tab_sjlvprpcbmzi_sjlvprpcbmzi, only: reduction
...
end module bind_c_reduction_tab_sjlvprpcbmzi_sjlvprpcbmzi
