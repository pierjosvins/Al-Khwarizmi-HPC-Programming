module bind_c_reduction_tab_n3sjelrklwjb_n3sjelrklwjb

  use reduction_tab_n3sjelrklwjb_n3sjelrklwjb, only: &
        initialize_table_openmp
  use reduction_tab_n3sjelrklwjb_n3sjelrklwjb, only: reduction_openmp
  use reduction_tab_n3sjelrklwjb_n3sjelrklwjb, only: threads_num
  use reduction_tab_n3sjelrklwjb_n3sjelrklwjb, only: reduction
  use reduction_tab_n3sjelrklwjb_n3sjelrklwjb, only: initialize_table
...
end module bind_c_reduction_tab_n3sjelrklwjb_n3sjelrklwjb
