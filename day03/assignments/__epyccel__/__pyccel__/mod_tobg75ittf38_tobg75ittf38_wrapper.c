...
PyObject *matrix_prod_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!pyarray_check(A_tmp, NPY_LONG, 2, NO_ORDER_CHECK))
    {
        return NULL;
    }
    else
    ...
    if (!pyarray_check(B_tmp, NPY_LONG, 2, NO_ORDER_CHECK))
    {
        return NULL;
    }
    else
    ...
    if (!pyarray_check(C_tmp, NPY_LONG, 2, NO_ORDER_CHECK))
    {
        return NULL;
    }
    else
...
static PyMethodDef mod_tobg75ittf38_tobg75ittf38_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_tobg75ittf38_tobg75ittf38_slots[] = {
...
static struct PyModuleDef mod_tobg75ittf38_tobg75ittf38_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_tobg75ittf38_tobg75ittf38",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_tobg75ittf38_tobg75ittf38_methods,
    mod_tobg75ittf38_tobg75ittf38_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_tobg75ittf38_tobg75ittf38(void)
{
    import_array();
    return PyModuleDef_Init(&mod_tobg75ittf38_tobg75ittf38_module);
}
