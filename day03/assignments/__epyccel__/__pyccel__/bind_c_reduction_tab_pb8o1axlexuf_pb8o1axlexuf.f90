module bind_c_reduction_tab_pb8o1axlexuf_pb8o1axlexuf

  use reduction_tab_pb8o1axlexuf_pb8o1axlexuf, only: initialize_table
  use reduction_tab_pb8o1axlexuf_pb8o1axlexuf, only: threads_num
  use reduction_tab_pb8o1axlexuf_pb8o1axlexuf, only: reduction
...
end module bind_c_reduction_tab_pb8o1axlexuf_pb8o1axlexuf
