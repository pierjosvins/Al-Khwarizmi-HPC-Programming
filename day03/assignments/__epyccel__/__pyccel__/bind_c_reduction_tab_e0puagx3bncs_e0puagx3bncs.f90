module bind_c_reduction_tab_e0puagx3bncs_e0puagx3bncs

  use reduction_tab_e0puagx3bncs_e0puagx3bncs, only: threads_num
  use reduction_tab_e0puagx3bncs_e0puagx3bncs, only: reduction
  use reduction_tab_e0puagx3bncs_e0puagx3bncs, only: initialize_table
...
end module bind_c_reduction_tab_e0puagx3bncs_e0puagx3bncs
