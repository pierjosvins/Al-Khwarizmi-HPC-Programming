...
static PyMethodDef mod_k6bplwc7gtvo_k6bplwc7gtvo_methods[] = {
    {
        "jacobi",
...
static PyModuleDef_Slot mod_k6bplwc7gtvo_k6bplwc7gtvo_slots[] = {
...
static struct PyModuleDef mod_k6bplwc7gtvo_k6bplwc7gtvo_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_k6bplwc7gtvo_k6bplwc7gtvo",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_k6bplwc7gtvo_k6bplwc7gtvo_methods,
    mod_k6bplwc7gtvo_k6bplwc7gtvo_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k6bplwc7gtvo_k6bplwc7gtvo(void)
{
    import_array();
    return PyModuleDef_Init(&mod_k6bplwc7gtvo_k6bplwc7gtvo_module);
}
