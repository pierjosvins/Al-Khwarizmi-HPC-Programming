...
static PyMethodDef pi_qtgenvdniquz_qtgenvdniquz_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_qtgenvdniquz_qtgenvdniquz_slots[] = {
...
static struct PyModuleDef pi_qtgenvdniquz_qtgenvdniquz_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_qtgenvdniquz_qtgenvdniquz",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_qtgenvdniquz_qtgenvdniquz_methods,
    pi_qtgenvdniquz_qtgenvdniquz_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_qtgenvdniquz_qtgenvdniquz(void)
{
    import_array();
    return PyModuleDef_Init(&pi_qtgenvdniquz_qtgenvdniquz_module);
}
