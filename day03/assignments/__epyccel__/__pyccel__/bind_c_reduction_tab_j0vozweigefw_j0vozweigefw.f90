module bind_c_reduction_tab_j0vozweigefw_j0vozweigefw

  use reduction_tab_j0vozweigefw_j0vozweigefw, only: threads_num
  use reduction_tab_j0vozweigefw_j0vozweigefw, only: initialize_table
  use reduction_tab_j0vozweigefw_j0vozweigefw, only: reduction
...
end module bind_c_reduction_tab_j0vozweigefw_j0vozweigefw
