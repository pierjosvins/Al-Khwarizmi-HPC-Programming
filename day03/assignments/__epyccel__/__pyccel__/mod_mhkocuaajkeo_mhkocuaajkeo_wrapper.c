...
static PyMethodDef mod_mhkocuaajkeo_mhkocuaajkeo_methods[] = {
    {
        "jacobi_with_openmp",
...
static PyModuleDef_Slot mod_mhkocuaajkeo_mhkocuaajkeo_slots[] = {
...
static struct PyModuleDef mod_mhkocuaajkeo_mhkocuaajkeo_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_mhkocuaajkeo_mhkocuaajkeo",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_mhkocuaajkeo_mhkocuaajkeo_methods,
    mod_mhkocuaajkeo_mhkocuaajkeo_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_mhkocuaajkeo_mhkocuaajkeo(void)
{
    import_array();
    return PyModuleDef_Init(&mod_mhkocuaajkeo_mhkocuaajkeo_module);
}
