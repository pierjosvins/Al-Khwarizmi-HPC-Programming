...
static PyMethodDef mod_xivsqcfvnwkg_xivsqcfvnwkg_methods[] = {
    {
        "jacobi_with_openmp",
...
static PyModuleDef_Slot mod_xivsqcfvnwkg_xivsqcfvnwkg_slots[] = {
...
static struct PyModuleDef mod_xivsqcfvnwkg_xivsqcfvnwkg_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_xivsqcfvnwkg_xivsqcfvnwkg",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_xivsqcfvnwkg_xivsqcfvnwkg_methods,
    mod_xivsqcfvnwkg_xivsqcfvnwkg_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xivsqcfvnwkg_xivsqcfvnwkg(void)
{
    import_array();
    return PyModuleDef_Init(&mod_xivsqcfvnwkg_xivsqcfvnwkg_module);
}
