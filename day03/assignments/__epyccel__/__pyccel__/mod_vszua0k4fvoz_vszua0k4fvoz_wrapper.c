...
static PyMethodDef mod_vszua0k4fvoz_vszua0k4fvoz_methods[] = {
    {
        "jacobi",
...
static PyModuleDef_Slot mod_vszua0k4fvoz_vszua0k4fvoz_slots[] = {
...
static struct PyModuleDef mod_vszua0k4fvoz_vszua0k4fvoz_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_vszua0k4fvoz_vszua0k4fvoz",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_vszua0k4fvoz_vszua0k4fvoz_methods,
    mod_vszua0k4fvoz_vszua0k4fvoz_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_vszua0k4fvoz_vszua0k4fvoz(void)
{
    import_array();
    return PyModuleDef_Init(&mod_vszua0k4fvoz_vszua0k4fvoz_module);
}
