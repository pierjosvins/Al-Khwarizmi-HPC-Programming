module bind_c_reduction_tab_zeg0nfbr01v2_zeg0nfbr01v2

  use reduction_tab_zeg0nfbr01v2_zeg0nfbr01v2, only: threads_num
  use reduction_tab_zeg0nfbr01v2_zeg0nfbr01v2, only: reduction
  use reduction_tab_zeg0nfbr01v2_zeg0nfbr01v2, only: initialize_table
...
end module bind_c_reduction_tab_zeg0nfbr01v2_zeg0nfbr01v2
