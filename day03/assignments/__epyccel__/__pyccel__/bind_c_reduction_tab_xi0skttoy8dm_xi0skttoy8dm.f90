module bind_c_reduction_tab_xi0skttoy8dm_xi0skttoy8dm

  use reduction_tab_xi0skttoy8dm_xi0skttoy8dm, only: initialize_table
  use reduction_tab_xi0skttoy8dm_xi0skttoy8dm, only: reduction
  use reduction_tab_xi0skttoy8dm_xi0skttoy8dm, only: threads_num
...
end module bind_c_reduction_tab_xi0skttoy8dm_xi0skttoy8dm
