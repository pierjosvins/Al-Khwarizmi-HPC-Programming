module bind_c_reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs

  use reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs, only: reduction_openmp
  use reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs, only: &
        initialize_table_openmp
  use reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs, only: reduction
  use reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs, only: threads_num
  use reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs, only: initialize_table
...
end module bind_c_reduction_tab_zd7xmc0tyjxs_zd7xmc0tyjxs
