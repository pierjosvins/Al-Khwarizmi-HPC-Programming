module bind_c_reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k

  use reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k, only: reduction_openmp
  use reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k, only: &
        initialize_table_openmp
  use reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k, only: initialize_table
  use reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k, only: threads_num
  use reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k, only: reduction
...
end module bind_c_reduction_tab_mvf8c7cl1y3k_mvf8c7cl1y3k
