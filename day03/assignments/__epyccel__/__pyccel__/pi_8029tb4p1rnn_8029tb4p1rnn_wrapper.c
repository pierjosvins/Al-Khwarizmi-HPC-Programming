...
static PyMethodDef pi_8029tb4p1rnn_8029tb4p1rnn_methods[] = {
    {
        "f",
...
static PyModuleDef_Slot pi_8029tb4p1rnn_8029tb4p1rnn_slots[] = {
...
static struct PyModuleDef pi_8029tb4p1rnn_8029tb4p1rnn_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "pi_8029tb4p1rnn_8029tb4p1rnn",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    pi_8029tb4p1rnn_8029tb4p1rnn_methods,
    pi_8029tb4p1rnn_8029tb4p1rnn_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_pi_8029tb4p1rnn_8029tb4p1rnn(void)
{
    import_array();
    return PyModuleDef_Init(&pi_8029tb4p1rnn_8029tb4p1rnn_module);
}
