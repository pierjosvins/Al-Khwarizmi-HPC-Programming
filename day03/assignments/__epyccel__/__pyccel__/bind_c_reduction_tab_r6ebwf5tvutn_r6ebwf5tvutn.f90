module bind_c_reduction_tab_r6ebwf5tvutn_r6ebwf5tvutn

  use reduction_tab_r6ebwf5tvutn_r6ebwf5tvutn, only: initialize_table
  use reduction_tab_r6ebwf5tvutn_r6ebwf5tvutn, only: threads_num
  use reduction_tab_r6ebwf5tvutn_r6ebwf5tvutn, only: reduction
...
end module bind_c_reduction_tab_r6ebwf5tvutn_r6ebwf5tvutn
