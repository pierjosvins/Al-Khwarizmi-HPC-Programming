module bind_c_reduction_tab_3zjrbpokiunm_3zjrbpokiunm

  use reduction_tab_3zjrbpokiunm_3zjrbpokiunm, only: initialize_table
  use reduction_tab_3zjrbpokiunm_3zjrbpokiunm, only: reduction
  use reduction_tab_3zjrbpokiunm_3zjrbpokiunm, only: reduction_openmp
  use reduction_tab_3zjrbpokiunm_3zjrbpokiunm, only: threads_num
  use reduction_tab_3zjrbpokiunm_3zjrbpokiunm, only: &
...
end module bind_c_reduction_tab_3zjrbpokiunm_3zjrbpokiunm
