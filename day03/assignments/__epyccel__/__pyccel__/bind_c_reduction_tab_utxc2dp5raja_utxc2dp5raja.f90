module bind_c_reduction_tab_utxc2dp5raja_utxc2dp5raja

  use reduction_tab_utxc2dp5raja_utxc2dp5raja, only: initialize_table
  use reduction_tab_utxc2dp5raja_utxc2dp5raja, only: reduction
  use reduction_tab_utxc2dp5raja_utxc2dp5raja, only: threads_num
...
end module bind_c_reduction_tab_utxc2dp5raja_utxc2dp5raja
