...
static PyMethodDef reduction_tab_lqmafvypvdfa_lqmafvypvdfa_methods[] = {
    {
        "threads_num",
...
static PyModuleDef_Slot reduction_tab_lqmafvypvdfa_lqmafvypvdfa_slots[] = {
...
static struct PyModuleDef reduction_tab_lqmafvypvdfa_lqmafvypvdfa_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "reduction_tab_lqmafvypvdfa_lqmafvypvdfa",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    reduction_tab_lqmafvypvdfa_lqmafvypvdfa_methods,
    reduction_tab_lqmafvypvdfa_lqmafvypvdfa_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_reduction_tab_lqmafvypvdfa_lqmafvypvdfa(void)
{
    import_array();
    return PyModuleDef_Init(&reduction_tab_lqmafvypvdfa_lqmafvypvdfa_module);
}
