module bind_c_reduction_tab_zbhv6ovfs1wo_zbhv6ovfs1wo

  use reduction_tab_zbhv6ovfs1wo_zbhv6ovfs1wo, only: threads_num
  use reduction_tab_zbhv6ovfs1wo_zbhv6ovfs1wo, only: reduction
  use reduction_tab_zbhv6ovfs1wo_zbhv6ovfs1wo, only: initialize_table
...
end module bind_c_reduction_tab_zbhv6ovfs1wo_zbhv6ovfs1wo
