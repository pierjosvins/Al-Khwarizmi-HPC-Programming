...
static PyMethodDef reduction_tab_q834f30a7fet_q834f30a7fet_methods[] = {
    {
        "threads_num",
...
static PyModuleDef_Slot reduction_tab_q834f30a7fet_q834f30a7fet_slots[] = {
...
static struct PyModuleDef reduction_tab_q834f30a7fet_q834f30a7fet_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "reduction_tab_q834f30a7fet_q834f30a7fet",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    reduction_tab_q834f30a7fet_q834f30a7fet_methods,
    reduction_tab_q834f30a7fet_q834f30a7fet_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_reduction_tab_q834f30a7fet_q834f30a7fet(void)
{
    import_array();
    return PyModuleDef_Init(&reduction_tab_q834f30a7fet_q834f30a7fet_module);
}
