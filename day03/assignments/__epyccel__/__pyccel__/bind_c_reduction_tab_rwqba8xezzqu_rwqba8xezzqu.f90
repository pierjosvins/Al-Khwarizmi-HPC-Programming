module bind_c_reduction_tab_rwqba8xezzqu_rwqba8xezzqu

  use reduction_tab_rwqba8xezzqu_rwqba8xezzqu, only: initialize_table
  use reduction_tab_rwqba8xezzqu_rwqba8xezzqu, only: threads_num
  use reduction_tab_rwqba8xezzqu_rwqba8xezzqu, only: reduction
...
end module bind_c_reduction_tab_rwqba8xezzqu_rwqba8xezzqu
