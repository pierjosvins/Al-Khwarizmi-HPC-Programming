module bind_c_reduction_tab_hz5reo2zpppp_hz5reo2zpppp

  use reduction_tab_hz5reo2zpppp_hz5reo2zpppp, only: initialize_table
  use reduction_tab_hz5reo2zpppp_hz5reo2zpppp, only: reduction
  use reduction_tab_hz5reo2zpppp_hz5reo2zpppp, only: &
        initialize_table_openmp
  use reduction_tab_hz5reo2zpppp_hz5reo2zpppp, only: threads_num
  use reduction_tab_hz5reo2zpppp_hz5reo2zpppp, only: reduction_openmp
...
end module bind_c_reduction_tab_hz5reo2zpppp_hz5reo2zpppp
