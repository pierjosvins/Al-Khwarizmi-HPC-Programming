...
/*........................................*/
PyObject *matrix_prod_openmp_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    matrix_prod_openmp(A, B, C, N, M, nb_threads);
...
static PyMethodDef mod_dwxputooguke_dwxputooguke_methods[] = {
    {
        "matrix_prod_openmp",
        (PyCFunction)matrix_prod_openmp_wrapper,
...
static PyModuleDef_Slot mod_dwxputooguke_dwxputooguke_slots[] = {
...
static struct PyModuleDef mod_dwxputooguke_dwxputooguke_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_dwxputooguke_dwxputooguke",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_dwxputooguke_dwxputooguke_methods,
    mod_dwxputooguke_dwxputooguke_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dwxputooguke_dwxputooguke(void)
{
    import_array();
    return PyModuleDef_Init(&mod_dwxputooguke_dwxputooguke_module);
}
