module bind_c_reduction_tab_keus8xgrg4we_keus8xgrg4we

  use reduction_tab_keus8xgrg4we_keus8xgrg4we, only: threads_num
  use reduction_tab_keus8xgrg4we_keus8xgrg4we, only: reduction
  use reduction_tab_keus8xgrg4we_keus8xgrg4we, only: initialize_table
...
end module bind_c_reduction_tab_keus8xgrg4we_keus8xgrg4we
