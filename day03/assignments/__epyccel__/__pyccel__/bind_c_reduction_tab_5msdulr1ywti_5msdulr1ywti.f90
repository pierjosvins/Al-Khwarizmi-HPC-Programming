module bind_c_reduction_tab_5msdulr1ywti_5msdulr1ywti

  use reduction_tab_5msdulr1ywti_5msdulr1ywti, only: reduction
  use reduction_tab_5msdulr1ywti_5msdulr1ywti, only: threads_num
  use reduction_tab_5msdulr1ywti_5msdulr1ywti, only: initialize_table
...
end module bind_c_reduction_tab_5msdulr1ywti_5msdulr1ywti
