module bind_c_reduction_tab_wiaqqcwchl4z_wiaqqcwchl4z

  use reduction_tab_wiaqqcwchl4z_wiaqqcwchl4z, only: reduction
  use reduction_tab_wiaqqcwchl4z_wiaqqcwchl4z, only: initialize_table
  use reduction_tab_wiaqqcwchl4z_wiaqqcwchl4z, only: threads_num
...
end module bind_c_reduction_tab_wiaqqcwchl4z_wiaqqcwchl4z
