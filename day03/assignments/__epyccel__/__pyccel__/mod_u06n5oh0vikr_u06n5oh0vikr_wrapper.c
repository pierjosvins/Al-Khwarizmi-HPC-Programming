...
static PyMethodDef mod_u06n5oh0vikr_u06n5oh0vikr_methods[] = {
    {
...
static PyModuleDef_Slot mod_u06n5oh0vikr_u06n5oh0vikr_slots[] = {
...
static struct PyModuleDef mod_u06n5oh0vikr_u06n5oh0vikr_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_u06n5oh0vikr_u06n5oh0vikr",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_u06n5oh0vikr_u06n5oh0vikr_methods,
    mod_u06n5oh0vikr_u06n5oh0vikr_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_u06n5oh0vikr_u06n5oh0vikr(void)
{
    import_array();
    return PyModuleDef_Init(&mod_u06n5oh0vikr_u06n5oh0vikr_module);
}
