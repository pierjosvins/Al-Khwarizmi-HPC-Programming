module bind_c_reduction_tab_wvktfid46rpf_wvktfid46rpf

  use reduction_tab_wvktfid46rpf_wvktfid46rpf, only: initialize_table
  use reduction_tab_wvktfid46rpf_wvktfid46rpf, only: reduction
  use reduction_tab_wvktfid46rpf_wvktfid46rpf, only: threads_num
...
end module bind_c_reduction_tab_wvktfid46rpf_wvktfid46rpf
