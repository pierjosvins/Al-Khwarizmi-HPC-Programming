module bind_c_reduction_tab_elb7kf33xnak_elb7kf33xnak

  use reduction_tab_elb7kf33xnak_elb7kf33xnak, only: threads_num
  use reduction_tab_elb7kf33xnak_elb7kf33xnak, only: initialize_table
  use reduction_tab_elb7kf33xnak_elb7kf33xnak, only: reduction
...
end module bind_c_reduction_tab_elb7kf33xnak_elb7kf33xnak
