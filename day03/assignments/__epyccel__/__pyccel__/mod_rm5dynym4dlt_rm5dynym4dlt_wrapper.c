...
static PyMethodDef mod_rm5dynym4dlt_rm5dynym4dlt_methods[] = {
    {
        "jacobi_with_openmp",
...
static PyModuleDef_Slot mod_rm5dynym4dlt_rm5dynym4dlt_slots[] = {
...
static struct PyModuleDef mod_rm5dynym4dlt_rm5dynym4dlt_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_rm5dynym4dlt_rm5dynym4dlt",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_rm5dynym4dlt_rm5dynym4dlt_methods,
    mod_rm5dynym4dlt_rm5dynym4dlt_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rm5dynym4dlt_rm5dynym4dlt(void)
{
    import_array();
    return PyModuleDef_Init(&mod_rm5dynym4dlt_rm5dynym4dlt_module);
}
