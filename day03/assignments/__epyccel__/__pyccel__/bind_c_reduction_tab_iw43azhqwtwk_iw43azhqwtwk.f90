module bind_c_reduction_tab_iw43azhqwtwk_iw43azhqwtwk

  use reduction_tab_iw43azhqwtwk_iw43azhqwtwk, only: initialize_table
  use reduction_tab_iw43azhqwtwk_iw43azhqwtwk, only: threads_num
  use reduction_tab_iw43azhqwtwk_iw43azhqwtwk, only: reduction
...
end module bind_c_reduction_tab_iw43azhqwtwk_iw43azhqwtwk
