module bind_c_reduction_tab_umztu23rflpo_umztu23rflpo

  use reduction_tab_umztu23rflpo_umztu23rflpo, only: initialize_table
  use reduction_tab_umztu23rflpo_umztu23rflpo, only: reduction
  use reduction_tab_umztu23rflpo_umztu23rflpo, only: &
        initialize_table_openmp
  use reduction_tab_umztu23rflpo_umztu23rflpo, only: reduction_openmp
  use reduction_tab_umztu23rflpo_umztu23rflpo, only: threads_num
...
end module bind_c_reduction_tab_umztu23rflpo_umztu23rflpo
