module bind_c_reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7

  use reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7, only: &
        initialize_table_openmp
  use reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7, only: reduction
  use reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7, only: reduction_openmp
  use reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7, only: initialize_table
  use reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7, only: threads_num
...
end module bind_c_reduction_tab_fwc4w4h8nur7_fwc4w4h8nur7
