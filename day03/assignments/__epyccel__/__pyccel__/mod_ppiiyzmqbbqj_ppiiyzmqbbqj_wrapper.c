...
static PyMethodDef mod_ppiiyzmqbbqj_ppiiyzmqbbqj_methods[] = {
    {
        "jacobi_with_openmp",
...
static PyModuleDef_Slot mod_ppiiyzmqbbqj_ppiiyzmqbbqj_slots[] = {
...
static struct PyModuleDef mod_ppiiyzmqbbqj_ppiiyzmqbbqj_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_ppiiyzmqbbqj_ppiiyzmqbbqj",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_ppiiyzmqbbqj_ppiiyzmqbbqj_methods,
    mod_ppiiyzmqbbqj_ppiiyzmqbbqj_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ppiiyzmqbbqj_ppiiyzmqbbqj(void)
{
    import_array();
    return PyModuleDef_Init(&mod_ppiiyzmqbbqj_ppiiyzmqbbqj_module);
}
