module bind_c_reduction_tab_nwrcfxmwv0ys_nwrcfxmwv0ys

  use reduction_tab_nwrcfxmwv0ys_nwrcfxmwv0ys, only: initialize_table
  use reduction_tab_nwrcfxmwv0ys_nwrcfxmwv0ys, only: reduction
  use reduction_tab_nwrcfxmwv0ys_nwrcfxmwv0ys, only: threads_num
...
end module bind_c_reduction_tab_nwrcfxmwv0ys_nwrcfxmwv0ys
