...
static PyMethodDef mod_qruskxerbljp_qruskxerbljp_methods[] = {
    {
        "jacobi_with_openmp",
...
static PyModuleDef_Slot mod_qruskxerbljp_qruskxerbljp_slots[] = {
...
static struct PyModuleDef mod_qruskxerbljp_qruskxerbljp_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_qruskxerbljp_qruskxerbljp",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_qruskxerbljp_qruskxerbljp_methods,
    mod_qruskxerbljp_qruskxerbljp_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_qruskxerbljp_qruskxerbljp(void)
{
    import_array();
    return PyModuleDef_Init(&mod_qruskxerbljp_qruskxerbljp_module);
}
