...
void bind_c_initialize_table_openmp(int64_t n0_tab, int64_t n1_tab, int64_t n2_tab, double *tab, int64_t nmolec, int64_t n, int64_t nmol);
...
void bind_c_reduction_openmp(int64_t n0_tab, int64_t n1_tab, int64_t n2_tab, double *tab, int64_t n0_tab1, double *tab1, int64_t n0_tab2, double *tab2, int64_t nmolec, int64_t nmol, int64_t n);
...
/*........................................*/
PyObject *initialize_table_openmp_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    t_ndarray tab = {.shape = NULL};
    int64_t nmolec;
    int64_t n;
    ...
    bind_c_initialize_table_openmp(nd_ndim(&tab, 0), nd_ndim(&tab, 1), nd_ndim(&tab, 2), nd_data(&tab), nmolec, n, nmol);
    result = Py_BuildValue("");
    free_pointer(tab);
    return result;
}
...
/*........................................*/
PyObject *reduction_openmp_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    t_ndarray tab = {.shape = NULL};
    t_ndarray tab1 = {.shape = NULL};
    t_ndarray tab2 = {.shape = NULL};
    ...
    bind_c_reduction_openmp(nd_ndim(&tab, 0), nd_ndim(&tab, 1), nd_ndim(&tab, 2), nd_data(&tab), nd_ndim(&tab1, 0), nd_data(&tab1), nd_ndim(&tab2, 0), nd_data(&tab2), nmolec, nmol, n);
    result = Py_BuildValue("");
    free_pointer(tab);
    free_pointer(tab1);
    free_pointer(tab2);
...
static PyMethodDef reduction_tab_9kvy7j590l7m_9kvy7j590l7m_methods[] = {
    {
        "threads_num",
    ...
    },
    {
        ...
        (PyCFunction)initialize_table_openmp_wrapper,
        METH_VARARGS | METH_KEYWORDS,
        ""
    },
    {
    ...
    {
        "reduction_openmp",
        (PyCFunction)reduction_openmp_wrapper,
        METH_VARARGS | METH_KEYWORDS,
        ""
    },
    { NULL, NULL, 0, NULL}
...
static PyModuleDef_Slot reduction_tab_9kvy7j590l7m_9kvy7j590l7m_slots[] = {
...
static struct PyModuleDef reduction_tab_9kvy7j590l7m_9kvy7j590l7m_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "reduction_tab_9kvy7j590l7m_9kvy7j590l7m",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    reduction_tab_9kvy7j590l7m_9kvy7j590l7m_methods,
    reduction_tab_9kvy7j590l7m_9kvy7j590l7m_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_reduction_tab_9kvy7j590l7m_9kvy7j590l7m(void)
{
    import_array();
    return PyModuleDef_Init(&reduction_tab_9kvy7j590l7m_9kvy7j590l7m_module);
}
