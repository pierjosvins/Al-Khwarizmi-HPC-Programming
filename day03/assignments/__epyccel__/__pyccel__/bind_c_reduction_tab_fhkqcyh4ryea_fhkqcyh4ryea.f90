module bind_c_reduction_tab_fhkqcyh4ryea_fhkqcyh4ryea

  use reduction_tab_fhkqcyh4ryea_fhkqcyh4ryea, only: initialize_table
  use reduction_tab_fhkqcyh4ryea_fhkqcyh4ryea, only: reduction
  use reduction_tab_fhkqcyh4ryea_fhkqcyh4ryea, only: threads_num
...
end module bind_c_reduction_tab_fhkqcyh4ryea_fhkqcyh4ryea
