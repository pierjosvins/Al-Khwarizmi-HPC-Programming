...
int64_t bind_c_solve_1d_nonlinearconv_pyccel(int64_t n0_u, double *u, int64_t n0_un, double *un, int64_t nt, int64_t nx, double dt, double dx);
...
PyObject *solve_1d_nonlinearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_solve_1d_nonlinearconv_pyccel(nd_ndim(&u, 0), nd_data(&u), nd_ndim(&un, 0), nd_data(&un), nt, nx, dt, dx);
...
static PyMethodDef mod_6im2pz38aqsn_6im2pz38aqsn_methods[] = {
    {
...
static PyModuleDef_Slot mod_6im2pz38aqsn_6im2pz38aqsn_slots[] = {
...
static struct PyModuleDef mod_6im2pz38aqsn_6im2pz38aqsn_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_6im2pz38aqsn_6im2pz38aqsn",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_6im2pz38aqsn_6im2pz38aqsn_methods,
    mod_6im2pz38aqsn_6im2pz38aqsn_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6im2pz38aqsn_6im2pz38aqsn(void)
{
    import_array();
    return PyModuleDef_Init(&mod_6im2pz38aqsn_6im2pz38aqsn_module);
}
