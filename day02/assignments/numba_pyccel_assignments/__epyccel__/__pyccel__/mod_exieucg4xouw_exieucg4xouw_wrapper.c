...
int64_t bind_c_solve_1d_diff_pyccel(int64_t n0_u, double *u, int64_t n0_un, double *un, int64_t nt, int64_t nx, double dt, double dx, double nu);
...
PyObject *solve_1d_diff_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_solve_1d_diff_pyccel(nd_ndim(&u, 0), nd_data(&u), nd_ndim(&un, 0), nd_data(&un), nt, nx, dt, dx, nu);
...
static PyMethodDef mod_exieucg4xouw_exieucg4xouw_methods[] = {
    {
...
static PyModuleDef_Slot mod_exieucg4xouw_exieucg4xouw_slots[] = {
...
static struct PyModuleDef mod_exieucg4xouw_exieucg4xouw_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_exieucg4xouw_exieucg4xouw",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_exieucg4xouw_exieucg4xouw_methods,
    mod_exieucg4xouw_exieucg4xouw_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_exieucg4xouw_exieucg4xouw(void)
{
    import_array();
    return PyModuleDef_Init(&mod_exieucg4xouw_exieucg4xouw_module);
}
