module bind_c_mod_qkpgqlg5vvou_qkpgqlg5vvou

  use mod_qkpgqlg5vvou_qkpgqlg5vvou, only: solve_1d_linearconv_pyccel
...
end module bind_c_mod_qkpgqlg5vvou_qkpgqlg5vvou
