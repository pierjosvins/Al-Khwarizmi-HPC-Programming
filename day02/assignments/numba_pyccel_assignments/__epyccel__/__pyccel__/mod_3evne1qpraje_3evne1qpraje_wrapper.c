...
int64_t bind_c_solve_2d_linearconv_pyccel(int64_t n0_u, int64_t n1_u, double *u, int64_t n0_un, int64_t n1_un, double *un, int64_t nt, int64_t nx, double dt, double dx, double dy, double c);
...
PyObject *solve_2d_linearconv_pyccel_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!O!OOOOOO", kwlist, &PyArray_Type, &u_tmp, &PyArray_Type, &un_tmp, &nt_tmp, &nx_tmp, &dt_tmp, &dx_tmp, &dy_tmp, &c_tmp))
    {
        return NULL;
    }
    ...
    Out_0001 = bind_c_solve_2d_linearconv_pyccel(nd_ndim(&u, 0), nd_ndim(&u, 1), nd_data(&u), nd_ndim(&un, 0), nd_ndim(&un, 1), nd_data(&un), nt, nx, dt, dx, dy, c);
...
static PyMethodDef mod_3evne1qpraje_3evne1qpraje_methods[] = {
    {
...
static PyModuleDef_Slot mod_3evne1qpraje_3evne1qpraje_slots[] = {
...
static struct PyModuleDef mod_3evne1qpraje_3evne1qpraje_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_3evne1qpraje_3evne1qpraje",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_3evne1qpraje_3evne1qpraje_methods,
    mod_3evne1qpraje_3evne1qpraje_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_3evne1qpraje_3evne1qpraje(void)
{
    import_array();
    return PyModuleDef_Init(&mod_3evne1qpraje_3evne1qpraje_module);
}
