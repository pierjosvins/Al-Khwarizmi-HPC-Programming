...
static PyMethodDef mod_ql2d5y9kekvs_ql2d5y9kekvs_methods[] = {
    {
...
static PyModuleDef_Slot mod_ql2d5y9kekvs_ql2d5y9kekvs_slots[] = {
...
static struct PyModuleDef mod_ql2d5y9kekvs_ql2d5y9kekvs_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_ql2d5y9kekvs_ql2d5y9kekvs",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_ql2d5y9kekvs_ql2d5y9kekvs_methods,
    mod_ql2d5y9kekvs_ql2d5y9kekvs_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ql2d5y9kekvs_ql2d5y9kekvs(void)
{
    import_array();
    return PyModuleDef_Init(&mod_ql2d5y9kekvs_ql2d5y9kekvs_module);
}
